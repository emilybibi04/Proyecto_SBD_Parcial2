 ...
 * @author LUIS
 */
public class Interface_Empleado extends javax.swing.JFrame {

    /**
     * Creates new form Interface_Empleado
     */
    public Interface_Empleado() {
        initComponents();
        this.setLocationRelativeTo(null);
        //CConexion objConexion = new CConexion();
        //objConexion.estableceConexion();
        CEmpleado objEmpleado = new CEmpleado();
        objEmpleado.mostrarEmpleado(tbEmp);
    }
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        CEmpleado objEmpleado = new CEmpleado();
        objEmpleado.InsertarEmpleado(txtCedula, txtCargo, txtJefe);
        objEmpleado.mostrarEmpleado(tbEmp);
    }//GEN-LAST:event_btnGuardarActionPerformed

    private void tbEmpMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbEmpMouseClicked
        CEmpleado objEmpleado1 = new CEmpleado();
        objEmpleado1.seleccionarEmpleado(tbEmp, txtCedula, txtCargo, txtJefe);
    }//GEN-LAST:event_tbEmpMouseClicked

    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        CEmpleado objEmpleado2 = new CEmpleado();
        objEmpleado2.modificarEmpleado(txtCedula, txtCargo, txtJefe);
        objEmpleado2.mostrarEmpleado(tbEmp);
    }//GEN-LAST:event_btnModificarActionPerformed

    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        CEmpleado objEmpleado3 = new CEmpleado();
        objEmpleado3.EliminarEmpleado(txtCedula);
        objEmpleado3.mostrarEmpleado(tbEmp);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Interface_Empleado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Interface_Empleado().setVisible(true);
            }
        });
    }
